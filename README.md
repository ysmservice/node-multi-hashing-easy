...
#### Master Build Status
[![Build Status](https://travis-ci.org/turtlecoin/node8-multi-hashing.svg?branch=master)](https://travis-ci.org/node8-multi-hashing/turtlecoin) [![Build Status](https://ci.appveyor.com/api/projects/status/929lavutfanx3v66/branch/master?svg=true
)](https://ci.appveyor.com/project/brandonlehmann/node8-multi-hashing/branch/master)

#### Development Build Status
[![Build Status](https://travis-ci.org/turtlecoin/node8-multi-hashing.svg?branch=development)](https://travis-ci.org/node8-multi-hashing/turtlecoin) [![Build Status](https://ci.appveyor.com/api/projects/status/929lavutfanx3v66/branch/development?svg=true
